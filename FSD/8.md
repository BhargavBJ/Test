...
- Connect to MongoDB using Mongoose and native driver
- CRUD operations (Create, Read, Update, Delete)
- RESTful API with Express
- React frontend to display and manage product list
- Real-time update after adding or modifying products
